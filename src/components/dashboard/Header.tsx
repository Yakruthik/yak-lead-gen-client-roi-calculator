    ...
    <>
      <header className="text-center mb-10">
        <div className="mb-5 flex items-center justify-center gap-4">
          ...
          />
          <h1 className="text-4xl font-bold text-primary inline-block">
            YAK Lead Gen ROI Calculator
          </h1>
        </div>
      ...
      <div className="mb-8 text-center">
        ...
        <select
          ...
          className="px-4 py-2.5 text-base border-2 border-secondary rounded-lg bg-card text-foreground cursor-pointer transition-all hover:bg-muted focus:outline-none focus:ring-2 focus:ring-secondary"
        >
